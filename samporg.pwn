...
ocmd:createcar(playerid,params[])
{
	...
	ServerCar[idx][v_localid] = CreateVehicle(ServerCar[idx][v_cartype],ServerCar[idx][v_PosX],ServerCar[idx][v_PosY],ServerCar[idx][v_PosZ],ServerCar[idx][v_PosR],ServerCar[idx][v_color1],ServerCar[idx][v_color2],-1,0);
	if(SavcCarToDataBase(idx))return SCM(playerid,COLOR_BLUE,"You successfully created a new Vehicle!");
    //SendClientMessage(playerid, COLOR_RED, "Login unsuccessful, password is wrong!");
    return 1;
}
...
public SaveVehicle(idx)
{
	...
	ServerCar[idx][v_cartype],ServerCar[idx][v_PosX],ServerCar[idx][v_PosY],ServerCar[idx][v_PosZ],ServerCar[idx][v_PosR],ServerCar[idx][v_color1],ServerCar[idx][v_color2],ServerCar[idx][v_function],ServerCar[idx][v_valid]);
